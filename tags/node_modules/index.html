...
<option class=placeholder>------</option><option value=/bbs/><i class="fas fa-fw fa-comment"></i> BBS </option><option value=https://javanote.doc.lewky.cn/><i class="fas fa-fw fa-note"></i>JavaNote </option><option value=/tags/><i class="fas fa-fw fa-tag"></i>标签 </option><option value=/about/><i class="fas fa-fw fa-at"></i>关于 </option><option value=/posts/e62c38c4.html/><i class="fas fa-fw fa-cog"></i>建站日志</option></select>
